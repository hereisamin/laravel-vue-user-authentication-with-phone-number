...
/**
 *
 *   $sms=new SmsIR_SendMessage(config('smsir.API'),config('smsir.SEC'),'30002101002661',config('smsir.URL'));
 *   if($sent=$sms->sendMessage(['09129332006'],['به سایت زیر مراجعه نمایید www.qq3.ir '],'')){
 *   dd($sent);
 *   }
 *
