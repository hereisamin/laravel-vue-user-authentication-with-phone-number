<template>
    <div>
        <div class="min-h-screen bg-blue-100">
            <nav class="bg-blue-200 border-b border-blue-400">
                    ...
                    <div class="flex justify-between h-16">
                        <div class="flex">
                            ...
                            <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                                ...
                                <breeze-nav-link :href="route('login')" :active="route().current('login')">
                                    Dashboard
                                </breeze-nav-link>
                            </div>
                        </div>
                ...
                <div :class="{'block': showingNavigationDropdown, 'hidden': ! showingNavigationDropdown}" class="sm:hidden">
                    <div class="pt-2 pb-3 space-y-1">
                        ...
                        <breeze-responsive-nav-link :href="route('login')" :active="route().current('home')">
                            home
                        </breeze-responsive-nav-link>
                    </div>
                    ...
                    <div class="pt-4 pb-1 border-t border-gray-200">
                        <div class="px-4">
                            ...
                            <div class="font-medium text-sm text-gray-500">{{ $page.props.auth.user.phone }}</div>
                        </div>
